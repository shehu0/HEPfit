...
dnl ###### LOOPTOOLS PATH ######
AC_DEFUN([SUSYFIT_LOOPTOOLS_PATH],
[
...
AC_DEFUN([SUSYFIT_FEYNHIGGS_PATH],
[
...
cat << _SUSYFIT_EOF_ > config.susyfit
*****************************************************
